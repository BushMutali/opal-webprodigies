...
import { parseTextWithLinks } from "@/lib/fn";
    ...
    <div className="grid grid-cols-1 xl:grid-cols-3 lg:py-10 overflow-y-auto gap-5">
      <div className="flex flex-col lg:col-span-2 gap-y-10">
        ...
        <div className="flex flex-col text-2xl gap-y-4">
          ...
          <p className="text-[#9D9D9D] text-lg text-medium flex items-center gap-2 flex-wrap w-full">
            {parseTextWithLinks(video.description!)}
          </p>
        </div>
      </div>
